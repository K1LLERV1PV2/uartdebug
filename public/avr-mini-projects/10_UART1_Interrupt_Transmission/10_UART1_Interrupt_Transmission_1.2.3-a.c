...
int main(void) //### The Entry Point
{
    ...
    while (1) //### Main Infinite Loop
    {
        ...
        tx_byte_count = snprintf((char *)tx_buffer,
                                 ...
                                 "Register = 0x%X\r\n",
                                 0x1234); //### snprintf Message Construction
        ...
        /*
         * Example of uint16_t sending in native little-endian order
         * by USART_SendBuffer(...).
         *
         * uint16_t test_var = 0x1234;
